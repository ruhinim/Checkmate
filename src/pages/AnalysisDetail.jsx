        ...
        <main className="flex-1 p-8 overflow-y-auto custom-scrollbar flex flex-col gap-6">
          ...
          <div className="flex justify-between items-start shrink-0">
            <div className="max-w-3xl">
              ...
              <p className="text-sm text-slate-600 font-medium leading-relaxed max-w-2xl">
                Critical audit reveals significant misalignment with modern
                distributed systems. Legacy focus on Relational-only
                architecture creates substantial readiness gaps for NoSQL and
                Cloud deployments.
              </p>
            </div>
            ...
            <button
              ...
              className="px-6 py-4 bg-[#2563EB] hover:bg-blue-700 text-white rounded-[20px] font-black text-sm transition-all shadow-lg shadow-blue-500/30 flex items-center gap-3 mt-2"
            >
              <div className="text-left leading-tight">
                <div className="font-bold text-blue-100 text-[10px] uppercase tracking-wider">
                  View AI
                </div>
                <div>Recommendation Plan</div>
              </div>
              <Stethoscope size={24} />
            </button>
          </div>
          ...
          <div className="grid grid-cols-12 gap-6 min-h-0 shrink-0">
            ...
            <div className="col-span-4 bg-white rounded-[32px] p-8 border border-white shadow-xl shadow-slate-200/40 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-xs text-slate-500 font-medium leading-relaxed px-4">
                The curriculum is heavily skewed towards 1990s relational
                standards, lacking essential modern data engineering
                competencies.
              </p>
            </div>
          ...
          <div className="grid grid-cols-12 gap-6 pb-6">
              ...
              <div className="flex justify-between items-start mb-8">
                <div>
                  <h3 className="text-[22px] font-black text-slate-900 tracking-tight">
                    Student Feedback Influence
                  </h3>
                  <p className="text-[13px] text-slate-500 font-medium mt-1">
                    Frustration trends emerging from student internship
                    placement data.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6 flex-1">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm shadow-slate-100 flex-1 hover:border-red-100 transition-colors">
                    <div className="flex items-center gap-2 mb-4 text-[#E11D48]">
                      ...
                      <span className="text-[11px] font-black uppercase tracking-[2px]">
                        Workplace Irrelevance
                      </span>
                    </div>
                    <p className="text-[13px] text-slate-700 italic font-medium leading-relaxed">
                      "Felt completely unprepared for my internship where they
                      used MongoDB and DynamoDB exclusively."
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm shadow-slate-100 flex-1 hover:border-blue-100 transition-colors">
                    ...
                    <p className="text-[13px] text-slate-700 italic font-medium leading-relaxed">
                      "Needs more focus on how databases scale in the cloud
                      rather than manual disk management."
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-[24px] border border-slate-100 shadow-sm shadow-slate-100 flex flex-col items-center justify-center text-center hover:border-slate-200 transition-colors">
                  <h4 className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-8">
                    Sentiment Word Cloud
                  </h4>

                  {/* Word Cloud Arrangement */}
                  <div className="flex flex-wrap justify-center items-baseline gap-x-5 gap-y-3 px-4">
                    <span className="text-4xl font-black text-[#CB4538] tracking-tight">
                      Obsolete
                    </span>
                    <span className="text-2xl font-black text-[#5C8AE8] tracking-tight">
                      Outdated
                    </span>
                    ...
                    <span className="text-lg font-black text-[#ED746A]">
                      Frustrating
                    </span>
                  </div>
                </div>
            ...
            <div className="col-span-4 bg-[#E2E8F0] rounded-[32px] p-8 flex flex-col shadow-inner">
              <h3 className="text-[11px] font-black text-slate-600 uppercase tracking-widest mb-8">
              ...
              <div className="mt-8 pt-6 border-t border-slate-300">
                <p className="text-[10px] font-bold text-slate-500 mb-4">
                  Module historical performance trend
                </p>
...
function MetricCard({ color, icon, badge, value, title, desc }) {
  ...
  return (
    <div
      className={`bg-white rounded-[24px] p-6 shadow-xl shadow-slate-200/40 border-y border-r border-slate-100 border-l-4 ${isRed ? "border-l-[#E11D48]" : "border-l-[#2563EB]"} flex flex-col group hover:-translate-y-1 transition-transform`}
    >
      <div
        className={`flex items-center gap-2 text-[9px] font-black uppercase tracking-widest mb-4 ${isRed ? "text-[#E11D48]" : "text-[#2563EB]"}`}
      >
        {icon} {badge}
      </div>
